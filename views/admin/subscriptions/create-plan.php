...
<head>
    ...
    <title>إضافة خطة اشتراك - بوابة الأولمبياد العلمي الفلسطيني</title>
        ...
        <div class="row justify-content-center">
            <div class="col-lg-8">
                <div class="card shadow-sm">
                    ...
                    <div class="card-body">
                        <form method="POST" action="<?= $this->url('/admin/subscriptions/plans/store') ?>">
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <textarea name="description_ar" class="form-control" rows="3"><?= $this->e($_SESSION['old']['description_ar'] ?? '') ?></textarea>
                                </div>
                                
                                <!-- English Description -->
                                <div class="col-md-6">
                                    <label class="form-label">الوصف بالإنجليزية</label>
                                    <textarea name="description_en" class="form-control" rows="3"><?= $this->e($_SESSION['old']['description_en'] ?? '') ?></textarea>
                                </div>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="number" name="price" class="form-control" 
                                               ...
                                               value="<?= $this->e($_SESSION['old']['price'] ?? '0') ?>">
                                    </div>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="number" name="duration_months" class="form-control" 
                                           min="1" required
                                           value="<?= $this->e($_SESSION['old']['duration_months'] ?? '12') ?>">
                                </div>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <select name="user_type" class="form-select" required>
                                        <option value="student" <?= ($_SESSION['old']['user_type'] ?? '') === 'student' ? 'selected' : '' ?>>طالب</option>
                                        <option value="school" <?= ($_SESSION['old']['user_type'] ?? '') === 'school' ? 'selected' : '' ?>>مدرسة</option>
                                    </select>
                                </div>
                                ...
                                <div class="col-12">
                                    ...
                                    <textarea name="features" class="form-control" rows="5" 
                                              placeholder="أدخل كل ميزة في سطر منفصل"><?= $this->e($_SESSION['old']['features'] ?? '') ?></textarea>
                                ...
                                <div class="col-12">
                                    <div class="form-check">
                                        <input type="checkbox" name="is_active" class="form-check-input" id="is_active" 
                                               <?= ($_SESSION['old']['is_active'] ?? true) ? 'checked' : '' ?>>
